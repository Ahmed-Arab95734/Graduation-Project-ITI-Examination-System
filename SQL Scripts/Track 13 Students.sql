/*
============================================================================
== SCRIPT TO POPULATE DATA FOR TRACK 13: FULL STACK WEB DEVELOPMENT USING PYTHON (Corrected Birthdate Logic)
==
== STARTING IDs: 24000
== STUDENTS PER IBT: 25
...
-- --- ID Counters ---
DECLARE @StudentID_Start INT = 24000;
DECLARE @JobID_Start INT = 24000;
DECLARE @CertID_Start INT = 24000;
...
-- --- Track 13 (Python Full Stack) Specific Data ---

DECLARE @Python_Positions TABLE (ID INT IDENTITY(1,1), Name NVARCHAR(100));
INSERT INTO @Python_Positions (Name) VALUES
(N'Python Developer'), (N'Django Developer'), (N'Full Stack Engineer (Python)'), (N'Backend Developer (Python)'),
(N'Data Engineer'), (N'DevOps Engineer'), (N'React Developer'), (N'Software Engineer - Python'),
(N'Flask Developer');

DECLARE @Python_Companies TABLE (Company_ID INT);
INSERT INTO @Python_Companies (Company_ID) VALUES 
...
DECLARE @Python_Certs TABLE (ID INT IDENTITY(1,1), Name NVARCHAR(200));
INSERT INTO @Python_Certs (Name) VALUES
(N'Django for Everybody (Coursera)'), (N'Python for Data Science (DataCamp)'),
(N'Microsoft Certified: Azure Data Scientist Associate (DP-100)'), (N'React - The Complete Guide (Udemy)'),
(N'Docker & Kubernetes: The Practical Guide (Udacity)'), (N'Advanced Python (Mahara Tech)'),
(N'The Complete Python Pro Bootcamp (Udemy)'), (N'PostgreSQL for Everybody (Coursera)');

DECLARE @Python_Jobs TABLE (ID INT IDENTITY(1,1), Descr NVARCHAR(1000));
INSERT INTO @Python_Jobs (Descr) VALUES
(N'Build a simple blog with Django.'), (N'Create a REST API using Django REST Framework.'),
(N'Scrape a website using Beautiful Soup and Requests.'), (N'Develop a data analysis script with Pandas.'),
(N'Build a small web app with Flask.'), (N'Create a front-end component in React.'),
(N'Containerize a Django app with Docker.'), (N'Write unit tests for a Python module using Pytest.'),
(N'Set up a simple CI/CD pipeline for a Python project.'), (N'Build a small e-commerce API.'),
(N'Develop a simple Telegram bot with python-telegram-bot.'), (N'Automate a task using a Python script.'),
(N'Fix bugs in an existing React frontend.'), (N'Build a CRUD API using FastAPI.'),
(N'Refactor legacy Python 2 code to Python 3.'), (N'Optimize a PostgreSQL query for a Django app.'),
(N'Create a data visualization dashboard using Dash.');
...
WHERE ibt.Track_ID = 13; -- Python Full Stack

-- --- Target Courses (Track 13) ---
...
PRINT 'Starting data generation for Track 13: Python Full Stack...';
...
BEGIN
    ...
    BEGIN
        ...
        -- =================================================================
        -- !!! THIS IS THE CORRECTED BIRTHDATE LOGIC !!!
        -- =================================================================
        ...
        BEGIN
            ...
            SELECT TOP 1 @CertName = Name FROM @Python_Certs ORDER BY NEWID();
        ...
        BEGIN
            ...
            SELECT TOP 1 @JobDesc = Descr FROM @Python_Jobs ORDER BY NEWID();
        ...
        BEGIN
            ...
            BEGIN
                ...
                -- Get random company from the Python list
                SELECT TOP 1 @Company_ID = Company_ID FROM @Python_Companies ORDER BY NEWID();
                
                -- Get random position
                SELECT TOP 1 @Position = Name FROM @Python_Positions ORDER BY NEWID();
